...
| voltagepark | neocloud | `voltagepark`: H100 |
...
| `EU-CRI-H100-US` | the headline's unit, estimator, weights and gate, US block (US) |
| `EU-CRI-H100-BASIS-US` | `EU-CRI-H100` minus `EU-CRI-H100-US`, USD per GPU-hour; a gap on any day either leg gaps |
...
methodology_version: "0.6.0"       # effective 2026-10-01 (notice 2026-N3). See
